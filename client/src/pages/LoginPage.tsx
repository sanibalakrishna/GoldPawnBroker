      ...
      <div className="w-full max-w-md mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl font-bold text-foreground">PawnBroker</h1>
            <p className="text-muted-foreground">Gold & Silver Management System</p>
          </div>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-muted-foreground">
            Secure access to your pawn broker management system
          </p>
        </div>
      </div>
    </div>
